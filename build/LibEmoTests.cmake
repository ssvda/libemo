...
macro (add_emo_test TEST_NAME)
	...
	get_filename_component (REAL_TEST_NAME ${TEST_NAME} NAME)
	foreach (EMO_INTERN_TEST ${EMO_DISABLE_TESTS})
		if (${EMO_INTERN_TEST} STREQUAL ${REAL_TEST_NAME})
			set (EMO_INTERN_TEST_DISABLED TRUE)
			break ()
		endif (${EMO_INTERN_TEST} STREQUAL ${REAL_TEST_NAME})
